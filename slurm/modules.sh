...
module_list="Clarabel ClarabelRs Mosek Gurobi ECOS OSQP SCS HiGHS Hypatia Tulip Clarabel128 ClarabelHSDE ClarabelRsHSDE ClarabelNonchordal ClarabelRsNonchordal SeDuMi SDPT3"
