module ClarabelBenchmarks
    ...
    function rebuild()
        ...
        path = "./problem_sets/hard_socp/include_hard_socp.jl"
    ...
    #identical solvers with different names.   Useful
    #for benchmarking if configured with use_quad_obj = false, etc
    module ClarabelHSDE
        using Clarabel
    ...
    module ClarabelNonchordal
        using Clarabel
        Optimizer = Clarabel.Optimizer
    end
    export ClarabelNonchordal

    module ClarabelRsNonchordal
        #using ClarabelRs
        #Optimizer = ClarabelRs.Optimizer
    end
